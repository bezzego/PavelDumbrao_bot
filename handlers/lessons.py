...
async def lessons_button_handler(message: types.Message):
    ...
    await message.answer(
        ...
        "✅ **Что нужно сделать:**\n\n"
        "1. В каждом уроке на экране появятся **большие буквы**.\n"
    ...
    await message.answer(
        ...
        "[💬 Войти в чат (после подписки)](https://t.me/+EO4WCUeMnV5hYjFi)\n\n"
        "*Отправь кодовое слово после этого сообщения или в любой момент использования бота*\n",
        parse_mode="Markdown",
    )
...
Йоу, кожаный.😎 [Я Павел Думбрао Ai](https://t.me/c/2624052018/20)
...
1. [Зарегистрируй GPT](https://t.me/c/2624052018/48) — бесплатную версию или лучше сразу платную (если хочешь по‑взрослому)
2. [Установи VPN](https://t.me/c/2624052018/50) на комп или телефон (если ты из России — без этого никак)
3. [Изучи правила и инструкции](https://t.me/c/2624052018/47) канала — да, внимательно
    ...
    if code_index == progress:
        ...
        if next_index < len(LESSON_TEXTS):
            await message.answer(
                ...
                "[👉 Перейти в канал](https://t.me/+olZLwPvR2RoyY2Uy)\n\n"
                "**2. Только после подписки тебя пустит в чат участников:**\n\n"
                "[💬 Войти в чат](https://t.me/+EO4WCUeMnV5hYjFi)",
                parse_mode="Markdown",
            )
            await asyncio.sleep(10)
